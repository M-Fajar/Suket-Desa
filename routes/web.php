...
Route::middleware('auth')->group(function () {
    ...
    Route::get('/download-kelahiran/{ajuan:id}', 'User\DownloadController@kelahiranDownload')->name('kelahiran.download');
    Route::get('/suket-kelahiran/{ajuan:id}', 'User\DownloadController@kelahiranLihat')->name('kelahiran.lihat');
...
Route::group(['middleware' => ['can:setingumum']], function () {
    ...
    // // // Kelahiran
    Route::get('/arsip-kelahiran', 'Admin\ArsipController@kelahiran')->name('arsip.kelahiran');
    Route::get('/adm-dwnld-kelahiran/{kelahiran:id}', 'Admin\ArsipController@kelahiranDownload')->name('adm-kelahiran.download');
    Route::get('/adm-suket-kelahiran/{kelahiran:id}', 'Admin\ArsipController@kelahiranLihat')->name('adm-kelahiran.lihat');
    ...
    Route::get('/kelahiran-laporan', 'Admin\ArsipController@kelahiranLaporan')->name('kelahiran.laporan');
});
