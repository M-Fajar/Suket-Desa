...
<body>
    ...
    <table border="0" align="center" width=83% >
        <tr>
            <td colspan="3" style="text-align: justify"> Yang bertanda tangan di bawah ini, Kepala Desa Pinggirsari Kecamatan Arjasari Kabupaten Bandung, menerangkan dengan sebenarnya bahwa :</td>
        </tr>
        <!-- IDENTITAS PENGAJU -->
        <tr>
