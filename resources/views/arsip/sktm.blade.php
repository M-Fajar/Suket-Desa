...
<body>
    ...
    <table border="0" align="center" width=83%>
        ...
        <tr>
            <td>
                <p style="text-align: justify;">
                   Berdasarkan pengetahuan kami dan data yang ada benar bahwa yang bersangkutan Penduduk Desa Pinggirsari Kecamatan Arjasari Kabupaten Bandung. setelah melalui penelitian / pengamatan serta pengecekan langsung dari Tim Komisi yang terdiri dari Pekerja Sosial Masyarakat dan Saksi Pemberdayaan Masyarakat Kecamatan ARJASARI, bahwa nama tersebut diatas merupakan keluarga Pra Sejahtera/ Kurang Mampu/ Miskin yang memerlukan biaya
                </p>
                <p style="text-align: justify">
    ...
    <table border="0" align="center" width=83%>
        <tr>
            <td style="text-align: right; position:relative">
                Pinggirsari, {{ $sktm->updated_at->format('d F Y') }} <br>
