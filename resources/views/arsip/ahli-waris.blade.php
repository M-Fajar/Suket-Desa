...
<body>
    ...
    <table border="0" align="center" width=83%>
        ...
        <tr>
            <td>
                <p style="text-align: justify;">
                    Berdasarkan keterangan dari RT dan RW setempat benar bahwa yang bersangkutan Penduduk Desa Pinggirsari Kecamatan Arjasari Kabupaten Bandung dan merupakan {{ $ajuan->ahliWaris->hubungan }} dari {{ $ajuan->ahliWaris->nama_pewaris }} yang {{ $ajuan->ahliWaris->kejadian }} pada tanggal {{ $ajuan->ahliWaris->tanggal }}
                </p>
                <p style="text-align: justify;">
