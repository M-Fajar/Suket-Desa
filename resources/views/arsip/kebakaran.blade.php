...
<body>
    ...
    <table border="0" align="center" width=83%>
        ...
        <tr>
            <td>
                <p style="text-align: justify;">
                    Berdasarkan keterangan dari RT dan RW setempat benar bahwa yang bersangkutan Penduduk Desa Pinggirsari Kecamatan ARJASARI Kabupaten BANDUNG telah melaporkan kebakaran rumah beserta barang/dokumen penting berupa :
                </p>
            </td>
        </tr>
        <tr>
