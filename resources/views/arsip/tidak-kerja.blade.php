...
<body>
    ...
    <table border="0" align="center" width=83%>
        ...
        <tr>
            <td>
                <p style="text-align: justify;">
                    Orang tersebut diatas adalah benar-benar warga Desa Pinggirsari yang pada kesempatan ini tidak dapat masuk kerja sebagaimana mestinya dikarenakan: <b style="text-transform: uppercase;"><i>{{ $ajuan->tidakKerja->alasan }}</i></b>. Maka dari itu pihak perusahaan kiranya dapat memberi izin kepadanya pada:
                </p>
            </td>
        </tr>
    </table>
