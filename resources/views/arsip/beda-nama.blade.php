...
<body>
    ...
    <table border="0" align="center" width=83%>
        ...
        <tr>
            <td>
                <p style="text-align: justify;">
                    Berdasarkan keterangan dari RT dan RW setempat benar bahwa yang bersangkutan Penduduk Desa Pinggirsari Kecamatan ARJASARI Kabupaten BANDUNG dan terdapat perbedaan dalam penulisan {{ $ajuan->bedaNama->perbedaan }} di dalam {{ $ajuan->bedaNama->dokumen_benar }} tertulis {{ $ajuan->bedaNama->tertulis_benar }} sedangkan di dalam {{ $ajuan->bedaNama->dokumen_salah }} tertulis {{ $ajuan->bedaNama->tertulis_salah }}.  
                </p>
