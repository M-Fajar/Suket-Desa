...
<body>
    ...
    <table border="0" align="center" width=83%>
        ...
        <tr>
            <td>
                <p style="text-align: justify;">
                    Berdasarkan pengetahuan kami dan data yang ada benar bahwa yang bersangkutan Penduduk Desa Pinggirsari Kecamatan Arjasari Kabupaten Bandung dan pada saat ini memiliki usaha :
                </p>
    ...
    <table border="0" align="center" width=83%>
        <tr>
            <td style="text-align: right; position:relative">
                Pinggirsari, {{ $sku->updated_at->format('d F Y') }} <br>
