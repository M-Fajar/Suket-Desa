          ...
          <div class="media text-muted pt-3">
            ...
            <div class="media-body pb-3 mb-0 small lh-125 border-bottom border-gray">
              <div class="d-flex justify-content-between align-items-center w-100">
                ...
                <span class="d-block"> diajukan {{ $ajuan->created_at->format('d M Y') }} <b>&middot;</b> <a href="{{ route('sktm.lihat', $ajuan->id) }}" class="text-primary">Lihat</a> | <a href="{{ route('sktm.download', $ajuan->id) }}" class="text-success dropdown-toggle" id="downloadDropdown" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Download</a> 
                  <div class="dropdown-menu" aria-labelledby="downloadDropdown">
                    <a class="dropdown-item" href="{{ route('sktm.download', $ajuan->id) }}">Unduh SKTM</a>
                    <a class="dropdown-item" href="{{ route('sktm.anak', $ajuan->id) }}">Unduh SKTM Anak</a>
                  </div>
            </div>
          </div>
          @endforeach
