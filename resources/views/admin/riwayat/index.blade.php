                    ...
                    <div class="table-responsive">
                        <table id="example" class="table table-striped table-bordered">
                            ...
                            <tr>
                                ...
                                <td class="text-right">
                                    @if ($sktb->acc == 1)
                                        <a href="{{ route('adm-sktb.lihat', $sktb->id) }}" class="badge badge-warning">Lihat Surat</a>
                                    @elseif ($sktb->acc == 2)
                                        {{-- <a href="" class="badge badge-warning">Lihat Surat</a> --}}
                                    @endif
                                </td>
                            ...
                            <tr>
                                ...
                                <td class="text-right">
                                    @if ($sktm->acc == 1)
                                        <a href="{{ route('adm-sktm.lihat', $sktm->id) }}" class="badge badge-warning">Lihat Surat</a>
                                    @elseif ($sktm->acc == 2)
                                        {{-- <a href="" class="badge badge-warning">Lihat Surat</a> --}}
                                    @endif
                                </td>
                            ...
                            <tr>
                                ...
                                <td class="text-right">
                                    @if ($skck->acc == 1)
                                        <a href="{{ route('adm-skck.lihat', $skck->id) }}" class="badge badge-warning">Lihat Surat</a>
                                    @elseif ($skck->acc == 2)
                                        {{-- <a href="" class="badge badge-warning">Lihat Surat</a> --}}
                                    @endif
                                </td>
                            ...
                            <tr>
                                ...
                                <td>
                                    @if ($puskesos->acc == 1)
                                        <span class="text-success"><b>Diterima</b></span>
                                    @elseif ($puskesos->acc == 2)
                                        <span class="text-danger"><b>Ditolak</b></span>
                                    @endif
                                </td>
                                <td class="text-right">
                                    @if ($puskesos->acc == 1)
                                        <a href="{{ route('adm-puskesos.lihat', $puskesos->id) }}" class="badge badge-warning">Lihat Surat</a>
                                    @elseif ($puskesos->acc == 2)
                                        {{-- <a href="" class="badge badge-warning">Lihat Surat</a> --}}
                                    @endif
                                </td>
                            ...
                            <tr>
                                ...
                                <td>
                                    @if ($kelahiran->acc == 1)
                                        <span class="text-success"><b>Diterima</b></span>
                                    @elseif ($kelahiran->acc == 2)
                                        <span class="text-danger"><b>Ditolak</b></span>
                                    @endif
                                </td>
                                <td class="text-right">
                                    @if ($kelahiran->acc == 1)
                                        <a href="{{ route('adm-kelahiran.lihat', $kelahiran->id) }}" class="badge badge-warning">Lihat Surat</a>
                                    @elseif ($kelahiran->acc == 2)
                                        {{-- <a href="" class="badge badge-warning">Lihat Surat</a> --}}
                                    @endif
                                </td>
                            ...
                            <tr>
                                ...
                                <td class="text-right">
                                    @if ($sku->acc == 1)
                                        <a href="{{ route('adm-sku.lihat', $sku->id) }}" class="badge badge-warning">Lihat Surat</a>
                                    @elseif ($sku->acc == 2)
                                        {{-- <a href="" class="badge badge-warning">Lihat Surat</a> --}}
                                    @endif
                                </td>
