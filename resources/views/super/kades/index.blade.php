    ...
    <div class="content">
        <div class="container">
            ...
            <div class="d-flex justify-content-between mb-3">
              <h4 class="title text-center my-3">KEPALA DESA DAN PEJABAT PENGESAH SURAT SINDANGSUKA</h4>
                      ...
                      <div class="modal-dialog">
                        <div class="modal-content">
                          ...
                          <div class="modal-body">
                            Aktifkan <b>{{ $k->nama }}</b> sebagai<br><b>Kepala Desa Sindangsuka</b> saat ini?
                          </div>
