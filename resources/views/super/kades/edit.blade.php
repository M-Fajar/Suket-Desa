  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <p class="text-center">Anda yakin ingin menghapus <b>{{ $kades->nama }}</b> dari <i> Data Kepala Desa Sindangsuka</i> ?</p>
        <small class="text-secondary text-center">*tindakan ini akan membuat {{ $kades->nama }} tidak terdata lagi di data Kepala Desa Sindangsuka.</small>
      </div>
