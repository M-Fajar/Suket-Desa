...
<html lang="en">
  <head>
    ...
    <title>Suket Desa Pinggirsari</title>
    <style>
      .bd-placeholder-img {
        font-size: 1.125rem;
        text-anchor: middle;
  ...
  <body>
          ...
          <div class="carousel-item active bg-oren">
            <div class="container">
              ...
              <div class="carousel-caption text-left">
                <h1>SKCK.</h1>
                <p>Layanan pengajuan Surat Pengantar SKCK dari Desa Pinggirsari. gunakan layanan ini jika anda membutuhkan surat pengantar untuk keperluan di Polres.</p>
          ...
          <div class="carousel-item bg-oren2">
            <div class="container">
              ...
              <div class="carousel-caption text-right">
                ...
                <p class="black" width="60%">Layanan pengajuan online Desa Pinggirsari untuk Surat Keterangan Tidak Mampu khusus penduduk Desa Pinggirsari.</p>
          ...
          <div class="carousel-item bg-oren3">
            <div class="container">
              <div class="carousel-caption text-left">
                ...
                <p class="black">Layanan pengajuan online Surat Domisili khusus untuk penduduk Desa Pinggirsari.</p>
          ...
          <div class="carousel-item bg-oren">
            <div class="container">
              <div class="carousel-caption">
                ...
                <p>Layanan pengajuan online Desa Pinggirsari untuk Surat Keterangan Usaha, khusus untuk penduduk Desa Pinggirsari.</p>
          ...
          {{-- <div class="carousel-item bg-oren2">
            <div class="container">
              <div class="carousel-caption text-right">
                ...
                <p class="black">Layanan pengajuan surat online Desa Pinggirsari untuk Surat Laporan Kematian, khusus untuk penduduk Desa Pinggirsari.</p>
    ...
    <footer class="my-5 text-muted text-center text-small">
      <p class="mb-1">&copy; 2021 - Desa Pinggirsari</p>
